...
(function setupPWA(){
  ...
  if('serviceWorker' in navigator){
    window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker.js?v=11.56', {updateViaCache: 'none'}).catch(err=>console.warn('PWA service worker:',err)));
  }
